...
export const avatarOptions = [
  { id: 1, name: 'Luna', src: asset('/images/avatar-1.jpg'), tone: 'bg-peach/70' },
  { id: 2, name: 'Memo', src: asset('/images/avatar-2.jpg'), tone: 'bg-baby/70' },
  { id: 3, name: 'Coco', src: asset('/images/avatar-3.jpg'), tone: 'bg-mint/70' },
  { id: 4, name: 'Mori', src: asset('/images/avatar-4.jpg'), tone: 'bg-peach/50' },
];
...
export const companionCharacters = [
  {
    ...
    label: '萨摩耶',
    emoji: '🐶',
    image: asset('/images/samoyed.jpg'),
  ...
  },
  {
    ...
    label: '猫咪',
    emoji: '🐱',
    image: asset('/images/companion-cat.jpg'),
  ...
  },
  {
    ...
    label: '兔兔',
    emoji: '🐰',
    image: asset('/images/companion-rabbit.jpg'),
  ...
  },
  {
    ...
    label: '小熊',
    emoji: '🐻',
    image: asset('/images/companion-bear.jpg'),
...
export const cityFootprints = [
  ...
  },
  {
    ...
    place: '老城区小路',
    date: '2025.05.20',
    image: asset('/images/avatar-2.jpg'),
  },
  {
    title: '夜市小灯牌合照',
    note: '每个霓虹都像给我们写了注脚。',
    place: '河畔夜市',
    date: '2025.06.06',
    image: asset('/images/avatar-3.jpg'),
  },
];
...
export const foodMoments = [
  {
    ...
    place: '巷口甜品店',
    date: '2025.03.09',
    image: asset('/images/avatar-4.jpg'),
  },
  {
    title: '深夜热汤面',
    ...
    place: '24h 小馆',
    date: '2025.04.12',
    image: asset('/images/avatar-5.jpg'),
  },
  {
    title: '白白软软的萨摩耶咖啡厅',
